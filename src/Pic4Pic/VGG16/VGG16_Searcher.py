...
if __name__ == '__main__':
    query_image_path = 'playground/TEST_ToSearch/13.jpg'  
    storage_path = 'playground/TEST_Vectors_ResNet'  
    similar_images = search_similar_images(query_image_path, storage_path, transform, vgg16)
