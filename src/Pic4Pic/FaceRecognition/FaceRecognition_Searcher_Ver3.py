...
def find_similar_images(target_image_path, index_path, k=5):
    ...
    DictDistance = {}
    for img_Name, Lstimg_Vec in index.items():
        ThisDistance = face_recognition.face_distance( Lstimg_Vec, target_encoding )
        DictDistance[img_Name] = LstMinEle(ThisDistance)
...
index_path = r'playground\TEST_Vectors_FaceRecognition_MultiFace\IndexFile.npy'
